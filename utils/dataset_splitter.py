...
def split_datasets():
    ...
    ROBOFLOW_HUMAN_FACES_1_DIR = DATASETS_DIR / "Human-Faces-25"
    ROBOFLOW_HUMAN_FACES_2_DIR = DATASETS_DIR / "Human-Faces-1"
    ...
    if not os.path.exists(ROBOFLOW_HUMAN_FACES_1_DIR):
        raise FileNotFoundError(f"ROBOFLOW HUMAN FACES dataset directory '{ROBOFLOW_HUMAN_FACES_1_DIR}' does not exist.")
    ...
    split_dataset(
        train_images_dir=ROBOFLOW_HUMAN_FACES_1_DIR / "train" / "images",
        train_labels_dir=ROBOFLOW_HUMAN_FACES_1_DIR / "train" / "labels",
        val_images_dir=ROBOFLOW_HUMAN_FACES_1_DIR / "valid" / "images",
        val_labels_dir=ROBOFLOW_HUMAN_FACES_1_DIR / "valid" / "labels",
        subset_dir=SUBSET_DIR,
        max_samples=MAX_SAMPLES,
        train_split=TRAIN_SPLIT,
        val_split=VAL_SPLIT,
    ...
    split_dataset(
        train_images_dir=ROBOFLOW_HUMAN_FACES_2_DIR / "train" / "images",
        train_labels_dir=ROBOFLOW_HUMAN_FACES_2_DIR / "train" / "labels",
        val_images_dir=ROBOFLOW_HUMAN_FACES_2_DIR / "valid" / "images",
        val_labels_dir=ROBOFLOW_HUMAN_FACES_2_DIR / "valid" / "labels",
        subset_dir=SUBSET_DIR,
        max_samples=MAX_SAMPLES,
        train_split=TRAIN_SPLIT,
        val_split=VAL_SPLIT,
